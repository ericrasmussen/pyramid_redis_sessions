...
sys.path.insert(0, os.path.abspath('..'))
# add path where setup.py is so we can get the version
sys.path.insert(0, os.path.abspath('../..'))
...
latex_documents = [
  ('index', 'pyramid_redis_sessions.tex',
   u'pyramid\\_redis\\_sessions Documentation',
   u'Eric Rasmussen', 'manual'),
]
...
texinfo_documents = [
  ('index', 'pyramid_redis_sessions', u'pyramid_redis_sessions Documentation',
   u'Eric Rasmussen', 'pyramid_redis_sessions',
